...
class TestQuery:
    ...
    def test_queryStylesNames(self):
        ...
        assert set(r)==set([u"generic", u"point", u"line", u"polygon", u"raster", u"new_style", \
                            ...
                            u"municipio_area_monorampnoborder", u"municipio_area_monoramp", \
                            u"municipio_area_dualramp", u"municipio_area_comp_equal", \
                            u"municipio_area_comp_jenks", u"municipio_area_comp_quartile"])
    ...
    def test_queryFeatureTypeNames(self):
        ...
        assert set(r)==set([u"municipio", u"municipios_cordoba", u"municipios_sevilla", \
                            ...
                            u"municipios_area_monoramp", u"municipios_area_monorampnoborder", \
                            u"municipios_area_dualramp", u"municipio_area_comp_equal", \
                            u"municipio_area_comp_jenks", u"municipio_area_comp_quartile"])
    ...
    def test_getLayerNames(self):
        ...
        assert r==set([u"municipios_area_dualramp", u"municipio", u"municipios_sevilla", \
                       ...
                       u"municipios_area_monorampnoborder", u"municipio_area_comp_equal", \
                       u"municipio_area_comp_jenks", u"municipio_area_comp_quartile"])
